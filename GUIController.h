...
class GUIController {
	private:
		...
		const std::string HELP_TEXT = 
            ...
            "rename_class:\nUser will be prompted to type the existing class name, and then the new name.\n\n"
            "edit_fields:\nUser will be sent to a sub-menu, where they can enter in field editor commands.\n\n"
            "edit_methods:\nUser will be sent to a sub-menu, where they can enter in method editor commands (including a parameter editor sub-sub-menu).\n\n"
